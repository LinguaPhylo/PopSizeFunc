...
public class ExponentialPopulationTest {
    ...
    /**
     * Test the intensity and inverse intensity calculations of the ExponentialGrowthModel class.
     * This test verifies whether the getIntensity method can correctly calculate the cumulative intensity
     * and whether the getInverseIntensity method can find the original time point from the cumulative intensity.
     */
